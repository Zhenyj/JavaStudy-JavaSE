package Section4.接口.demo02.red;
...
public abstract class RedPacketFrame extends JFrame {
    ...
    private static final String DIR = "basic-code\\src\\Section4.接口\\pic";
...
//        Section4.System.out.println("层次面板||" + layeredPane);
        // Section4.System.out.println(layeredPane);
...
//        Section4.System.out.println("LOGO初始化...");
...
//        Section4.System.out.println("页面初始化...");
        initInputPanel();
        initOpenPanel();
        initShowPanel();
...
//        Section4.System.out.println("输入页面||" + inputPanel);
...
//        Section4.System.out.println("打开页面||" + openPanel);
    }
...
//        Section4.System.out.println("展示页面||" + showPanel);
        // ====================================
...
//        Section4.System.out.println("重新设置:新页面");
    ...
    private void addListener() {
        ...
        input_count.addKeyListener(new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent e) {
                // Section4.System.out.println(e);
//                Section4.System.out.println("个数:" + input_count.getText());
            }
        });
        input_msg.addKeyListener(new KeyAdapter() {
            ...
            public void keyReleased(KeyEvent e) {
                // Section4.System.out.println(e);
//                Section4.System.out.println("留言:" + input_msg.getText());
            }
        });
...
//                    Section4.System.out.println("跳转-->打开新页面");
...
//                Section4.System.out.println("跳转-->展示页面");

                moneyList = openWay.divide(totalMoney, count);

//                Section4.System.out.println(moneyList);
                /*
                 * showPanel 添加数据
                 *
                 */
