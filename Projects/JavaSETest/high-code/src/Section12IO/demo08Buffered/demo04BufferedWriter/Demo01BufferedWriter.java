package Section12IO.demo08Buffered.demo04BufferedWriter;
...
public class Demo01BufferedWriter {
  ...
  public static void main(String[] args) throws IOException {
   // 1.创建字符缓冲输出流对象,构造方法中传递字符输出流
   FileWriter fw = new FileWriter("high-code\\src\\Section12IO\\demo08Buffered\\b.txt");
